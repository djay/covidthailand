...
def vaccination_reports_files2(check=0,
    ...
    links2 = (link for f in folders for link in reversed(
        list(web_links(f, ext=ext, check=0, proxy=use_proxy, timeout=timeout, ignore_errors=True))))
...
def vaccination_reports():
    ...
    for link, date, dl in vaccination_reports_files2(check=6):
        ...
        if date < d("2021-12-11"):
            ...
            # as of Report weekly 48  28-11-2-12-2022.pdf" - no longer has the groups
            pass
        else:
